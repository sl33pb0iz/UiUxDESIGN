...
public class NetworkErrorFormView : MonoBehaviour
{
    public NetworkErrorFormController _controller;
    ...
    {
        _quitButton.onClickEvent.AddListener(() => _controller.ApplicationQuit());
    }
